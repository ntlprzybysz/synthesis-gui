...
urlpatterns = [
    ...
    path("about/", views.show_about),   # http://numlock.informatik.tu-chemnitz.de/synthesis/about/
    path("help/", views.show_help), # http://numlock.informatik.tu-chemnitz.de/synthesis/help/
