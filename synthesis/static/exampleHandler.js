...
function loadExample(chosenExample) {
    ...
    switch (chosenExample) {
        case "quick-101000-with-markers":
            projectInformation = {
                "projectName": "Quick test with model 101000 with markers",
                "textInput": "printing",
        ...
        case "printing-101000-with-markers":
            projectInformation = {
                "projectName": "Example printing with model 101000 with markers",
        ...
        case "mountain-101000-with-markers":
            projectInformation = {
                "projectName": "Example mountain with model 101000 with markers",
        ...
        case "wind-101000-with-markers":
            projectInformation = {
                "projectName": "Example north wind with model 101000 with markers",
